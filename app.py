...
#plot
    fig=px.bar(x=words, labels={'x':'Words', 'y':'Counts'}, title="Top 10 most Repeated words")
...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            st.warning("Disclaimer: AI Plagiarism dtector apps can assist in identifying potential instances of plagiarism; however, it is important to note that their results are not fully accurate! Please use this information with responsibilty and don't make the decision based on this tool completely.")
